...
> [Full Reference Index (A-Z)](INDEX.md) | [Discipline Learning Paths](disciplines/)
...
| [TCM Security Academy](https://academy.tcm-sec.com/courses) | Free tier with practical ethical hacking and SOC content |
| [PortSwigger Web Security Academy](https://portswigger.net/web-security) | Best free web application security training; interactive labs |
...
| [CISA Training Catalog](https://niccs.cisa.gov/training/catalog) | No-cost federal training including ICS/OT, cloud, and IR |
...
ATT&CK Navigator layer and machine-readable edge tables connecting the TeamStarWolf vendor stack to NIST 800-53 controls and ATT&CK techniques.
...
- Multiple heatmap modes: coverage, detection, exposure, compliance, and risk
