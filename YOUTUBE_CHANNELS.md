...
3. [Malware Analysis and Reverse Engineering](#malware-analysis-and-reverse-engineering)
4. [Detection Engineering and Blue Team](#detection-engineering-and-blue-team)
5. [Bug Bounty and Web App Security](#bug-bounty-and-web-app-security)
6. [Active Directory and Red Team](#active-directory-and-red-team)
7. [Cloud Security and DevSecOps](#cloud-security-and-devsecops)
8. [Exploit Development and Low-Level](#exploit-development-and-low-level)
9. [OSINT and Investigation](#osint-and-investigation)
10. [Threat Intelligence and APT Research](#threat-intelligence-and-apt-research)
...
18. [Conference Talks](#conference-talks)

---

## General Cybersecurity and Hacking
- **NetworkChuck** - https://www.youtube.com/@NetworkChuck - Approachable hands-on infosec, networking, Linux, Docker
- **John Hammond** - https://www.youtube.com/@_JohnHammond - CTFs, malware analysis, walkthroughs, tool demos
- **David Bombal** - https://www.youtube.com/@davidbombal - Networking, ethical hacking, certs, interviews
- **Hak5** - https://www.youtube.com/@hak5 - Hardware hacking gear, payloads, news (RubberDucky, Pineapple)
- **The Cyber Mentor (Heath Adams)** - https://www.youtube.com/@TCMSecurityAcademy - Pentest training, OSCP prep, eJPT
- **Null Byte** - https://www.youtube.com/@NullByteWHT - Hands-on hacking how-to videos
- **HackerSploit** - https://www.youtube.com/@HackerSploit - Pentest, Linux, Docker, blue team
- **STÖK** - https://www.youtube.com/@STOKfredrik - Bug bounty, methodology, recon
- **LiveOverflow** - https://www.youtube.com/@LiveOverflow - CTF, RE, exploit dev with deep explanations
- **Loi Liang Yang** - https://www.youtube.com/@LoiLiangYang - Pentest tools and techniques
...
- **Day Cyberwox** - https://www.youtube.com/@DayCyberwox - Cloud and reverse engineering
- **Guided Hacking** - https://www.youtube.com/@GuidedHacking - Game hacking and RE
- **Open Security Training** - https://www.youtube.com/@OpenSecurityTraining - University-level malware/RE courses (canonical course archive)
...
- **DFIR Diva** - https://www.youtube.com/@DFIRDiva - DFIR resources and walkthroughs
- **SANS Digital Forensics and Incident Response** - https://www.youtube.com/@SANSForensics - SANS DFIR content
- **SANS Cyber Defense** - https://www.youtube.com/@SANSCyberDefense - SANS blue-team content
- **Black Hills Information Security** - https://www.youtube.com/@BlackHillsInformationSecurity - Wild West Hackin' Fest, John Strand webcasts
- **Cyber Defenders** - https://www.youtube.com/@cyberdefenders - Blue-team labs and walkthroughs
- **Splunk** - https://www.youtube.com/@splunkofficial - Boss of the SOC, ESCU
- **Elastic** - https://www.youtube.com/@elastic - Detection engineering and EDR content
...
- **NahamSec (Ben Sadeghipour)** - https://www.youtube.com/@NahamSec - Bug bounty live hunts and methodology (very active)
...
- **PwnFunction** - https://www.youtube.com/@PwnFunction - Web app security explainers, XSS deep dives

## Active Directory and Red Team
- **Conda (Daniel Lowrie)** - https://www.youtube.com/@daniellowrie - Pentest tooling
- **ChrisGreer** - https://www.youtube.com/@ChrisGreer - Wireshark and network analysis
...
- **Cloud Security Podcast** - https://www.youtube.com/@CloudSecurityPodcast - Practitioner interviews
...
- **LiveOverflow** - https://www.youtube.com/@LiveOverflow - Binary exploitation, browser RCE deep dives
- **stacksmashing** - https://www.youtube.com/@stacksmashing - Hardware reverse engineering and glitching (canonical reference)
- **OST2 (Open Security Training 2)** - https://ost2.fyi/ - University-quality RE and exploit dev courses
- **gynvael** - https://www.youtube.com/@GynvaelEN - Project Zero researcher livestreams (English)

## OSINT and Investigation
- **Bellingcat** - https://www.youtube.com/@BellingcatOfficial - Investigative OSINT
- **Michael Bazzell (IntelTechniques)** - https://inteltechniques.com - Books and resources (web reference, no active YouTube channel)
...
- **CrowdStrike** - https://www.youtube.com/@CrowdStrike - Falcon platform and threat intel
- **Cisco Talos Intelligence Group** - https://www.youtube.com/@CiscoTalosIntelligenceGroup - Threat reports and malware analysis
...
- **Jeremy's IT Lab** - https://www.youtube.com/@JeremysITLab - CCNA preparation
...
- **stacksmashing** - https://www.youtube.com/@stacksmashing - Hardware RE and glitching
- **EEVblog** - https://www.youtube.com/@EEVblog - Electronics engineering (foundational for hardware security)
- **Joe Grand (Kingpin)** - https://www.youtube.com/@JoeGrand - Hardware-hacking legend; co-founder of @stake and original L0pht member
...
- **Anthropic** - https://www.youtube.com/@anthropic-ai - Claude content, AI safety
- **Lex Fridman** - https://www.youtube.com/@lexfridman - Long-form interviews with AI and security figures
...
- **Kitboga** - https://www.youtube.com/@KitbogaShow - Live scam-baiting recordings; reference for social-engineering tradecraft and phone-fraud awareness training

## News, Commentary and Career
- **SimplyCyber (Gerald Auger)** - https://www.youtube.com/@SimplyCyber - Career, news, interviews (very active)
- **Lawrence Systems** - https://www.youtube.com/@LAWRENCESYSTEMS - IT, networking, security operations
- **TLDR Sec** - https://www.youtube.com/@TLDRsec - Weekly security news
- **Antisyphon Training** - https://www.youtube.com/@AntisyphonTraining - Pay-what-you-can pentesting and detection-engineering courses (Black Hills Information Security training arm)
...
- **Cyber Warriors HQ** - https://www.youtube.com/@CyberWarriorsHQ - Career development, community discussion, industry interviews
...
- **Black Hat** - https://www.youtube.com/@BlackHatOfficialYT - Black Hat USA, EU, and Asia
- **RSA Conference** - https://www.youtube.com/@RSAConference - RSA keynotes and sessions
...
- **Hack In The Box** - https://www.youtube.com/@HITBSecConf - HITB conference recordings
- **Wild West Hackin' Fest** - https://www.youtube.com/@WildWestHackinFest - WWHF talks
...
## Black Hat Arsenal Companion Videos
...
- **MI-X demo** - https://www.youtube.com/watch?v=2FsnsJ0mr68 - Arsenal-linked vulnerability assessment demo
