...
<!--
  Maintenance notes:
  - All links are /-prefixed from repo root (docsify runs with relativePath: false).
  - Use "- " bullets only; mixing "-" and "*" splits the list and breaks nesting.
  - Section headers are bold text items; their docs nest one level under them
    (2-space indent). index.html styles headers via `strong` because docsify
...
- **🚨 Incident Response & Forensics**
  ...
  - [Reverse Engineering Reference](/REVERSE_ENGINEERING_REFERENCE.md)
