...
[Black Hat](https://www.blackhat.com/) is the premier enterprise security research conference, running USA (Las Vegas, August), Europe (London, December), and Asia (Singapore, May) editions annually. Briefings are peer-reviewed technical talks; Arsenal is a live tool demonstration track where security researchers demo working tools.
...
[DEF CON](https://defcon.org/) is the world's largest hacker conference, running annually in Las Vegas each August. DEF CON prioritizes practitioner talks over enterprise presentations and has a strong culture of releasing working tools and proof-of-concept code alongside research.
...
Security BSides events are community-organized conferences that emerged from presentations submitted to, but not accepted by, Black Hat. BSides Las Vegas (BSidesLV) runs alongside Black Hat each August. BSides events now operate in hundreds of cities worldwide.
...
[USENIX Security](https://www.usenix.org/conferences/byname/108) is one of the four top-tier academic security research venues, peer-reviewed and published as open access. Papers cover systems security, cryptography, network security, privacy engineering, and applied security with rigorous empirical methodology.
...
[ACM CCS](https://www.sigsac.org/ccs.html) is a top-four academic security venue covering applied cryptography, systems security, and network security. ACM's open access initiative makes most papers freely available via the [ACM Digital Library](https://dl.acm.org/).
...
[RSA Conference](https://www.rsaconference.com/) is the largest enterprise security event globally, with an emphasis on industry and product tracks alongside technical research. Most recorded sessions are available free on the RSA YouTube channel after the event.
...
[ShmooCon](https://shmoocon.org/) is a Washington D.C.-based community hacker conference known for technical depth and a practitioner-first culture. Attendance is deliberately limited; talks are recorded and published post-conference.
...
## Landmark Talks by Topic

A selection of historically significant and practically essential conference presentations, organized by security discipline.

### Web Application Security

| Year | Conference | Title | Speaker(s) | Key Contribution |
|---|---|---|---|---|
| 2019 | Black Hat USA | HTTP Desync Attacks: Request Smuggling Reborn | James Kettle (PortSwigger) | Revived HTTP request smuggling as a practical attack; published [desync tool](https://github.com/PortSwigger/http-request-smuggler) |
| 2020 | Black Hat USA | Web Cache Poisoning: Practical Exploitation | James Kettle | Systematic cache poisoning methodology across CDN implementations |
| 2022 | Black Hat USA | Hacking APIs | Corey Ball | Comprehensive API security testing methodology for REST and GraphQL |
| 2021 | Black Hat USA | Practical HTTP Header Smuggling | Nathan Davison | Request header injection via reverse proxy normalization inconsistencies |
...
| Year | Conference | Title | Speaker(s) | Key Contribution |
|---|---|---|---|---|
| 2018 | Black Hat USA | Assume Breach: AWS Privilege Escalation Methods | Spencer Gietzen (Rhino Security Labs) | Documented 21 distinct AWS IAM privilege escalation paths |
| 2019 | DEF CON 27 | Hacking Azure Active Directory | Dr. Nestori Syynimaa | Azure AD attack methodology; foundation for AADInternals tooling |
| 2020 | Black Hat USA | Cloud Shadow Admin Threat: 10 Permissions to Rule Them All | Idan Shamir, Zohar Shachar | Minimal IAM permission sets enabling full cloud compromise |
| 2023 | Black Hat USA | Hacking Multicloud Environments | Multiple speakers | Cross-cloud lateral movement techniques |

### Hardware & Embedded Systems

| Year | Conference | Title | Speaker(s) | Key Contribution |
|---|---|---|---|---|
| 2012 | DEF CON 20 | Hacking Hardware: The Lifecycle of a Hardware Hack | Joe Grand | JTAG, UART, and hardware reverse engineering methodology |
| 2015 | Black Hat USA | Breaking UEFI Security | Rafal Wojtczuk, Corey Kallenberg | UEFI firmware attacks and Secure Boot bypass techniques |
| 2019 | Black Hat USA | Exploiting Qualcomm WLAN and Modem Over The Air | Xiling Gong, Peter Pi | Baseband firmware attack techniques for mobile devices |

### Malware Analysis & Threat Intelligence

| Year | Conference | Title | Speaker(s) | Key Contribution |
|---|---|---|---|---|
| 2017 | Black Hat USA | NotPetya Technical Analysis | ESET Research | Analysis of the wiper component disguised as ransomware |
| 2020 | Black Hat USA | SUNBURST Backdoor Deep Dive | CrowdStrike, Volexity | Complete technical analysis of the SolarWinds supply chain implant |
| 2022 | DEF CON 30 | Tracking State-Sponsored Actors | Multiple CTI teams | Nation-state attribution methodology and infrastructure tracking |

### Radio Frequency & Wireless

| Year | Conference | Title | Speaker(s) | Key Contribution |
|---|---|---|---|---|
| 2015 | DEF CON 23 | Drive It Like You Hacked It | Samy Kamkar | RollJam attack against rolling code key fob systems |
| 2019 | Black Hat USA | Exploiting Bluetooth and Wi-Fi Chipset Firmware | Jiska Classen, Francesco Gringoli | Broadcom/Cypress shared chip vulnerabilities enabling cross-protocol attacks |
| 2021 | DEF CON 29 | Wireless Village Talks | Various | SDR-based protocol analysis and attack techniques |

### Social Engineering & Physical Security

| Year | Conference | Title | Speaker(s) | Key Contribution |
|---|---|---|---|---|
| 2016 | DEF CON 24 | I Will Hack You Live | Rachel Tobac | Live vishing demonstration and systematic pretexting methodology |
| 2018 | Black Hat USA | Open Source Intelligence: Using Social Media for Targeted Attacks | Various | OSINT-to-social engineering pipeline methodology |

---

## Finding Speaker Repositories
...
| Resource | URL | Notes |
|---|---|---|
| Awesome Security Talks | [github.com/PaulSec/awesome-sec-talks](https://github.com/PaulSec/awesome-sec-talks) | Community-maintained list of notable security talks with links |
| Iron Geek Conference Archive | [irongeek.com](https://www.irongeek.com/) | One of the most comprehensive archives of smaller conferences and BSides events |
| DEF CON Speakers Archive | [defcon.org/html/links/dc-speaker.html](https://defcon.org/html/links/dc-speaker.html) | All DEF CON speakers indexed by year |
| Black Hat Speaker Archive | [blackhat.com/html/bh-us-archives/](https://www.blackhat.com/html/bh-us-archives/) | All Black Hat USA speakers and abstracts |
