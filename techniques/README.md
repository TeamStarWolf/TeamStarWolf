...
|---|---|---|
| `T1001` | Data Obfuscation | [Command and Control](/techniques/command-and-control.md#t1001) |
| `T1001.001` | Junk Data | [Command and Control](/techniques/command-and-control.md#t1001001) |
| `T1001.002` | Steganography | [Command and Control](/techniques/command-and-control.md#t1001002) |
| `T1001.003` | Protocol or Service Impersonation | [Command and Control](/techniques/command-and-control.md#t1001003) |
| `T1003` | OS Credential Dumping | [Credential Access](/techniques/credential-access.md#t1003) |
| `T1003.001` | LSASS Memory | [Credential Access](/techniques/credential-access.md#t1003001) |
| `T1003.002` | Security Account Manager | [Credential Access](/techniques/credential-access.md#t1003002) |
| `T1003.003` | NTDS | [Credential Access](/techniques/credential-access.md#t1003003) |
| `T1003.004` | LSA Secrets | [Credential Access](/techniques/credential-access.md#t1003004) |
| `T1003.005` | Cached Domain Credentials | [Credential Access](/techniques/credential-access.md#t1003005) |
| `T1003.006` | DCSync | [Credential Access](/techniques/credential-access.md#t1003006) |
...
| `T1018` | Remote System Discovery | [Discovery](/techniques/discovery.md#t1018) |
| `T1020` | Automated Exfiltration | [Exfiltration](/techniques/exfiltration.md#t1020) |
| `T1020.001` | Traffic Duplication | [Exfiltration](/techniques/exfiltration.md#t1020001) |
| `T1021` | Remote Services | [Lateral Movement](/techniques/lateral-movement.md#t1021) |
| `T1021.001` | Remote Desktop Protocol | [Lateral Movement](/techniques/lateral-movement.md#t1021001) |
| `T1021.002` | SMB/Windows Admin Shares | [Lateral Movement](/techniques/lateral-movement.md#t1021002) |
| `T1021.003` | Distributed Component Object Model | [Lateral Movement](/techniques/lateral-movement.md#t1021003) |
| `T1021.004` | SSH | [Lateral Movement](/techniques/lateral-movement.md#t1021004) |
| `T1021.005` | VNC | [Lateral Movement](/techniques/lateral-movement.md#t1021005) |
| `T1021.006` | Windows Remote Management | [Lateral Movement](/techniques/lateral-movement.md#t1021006) |
...
| `T1037.003` | Network Logon Script | [Persistence](/techniques/persistence.md#t1037003) |
| `T1037.004` | RC Scripts | [Persistence](/techniques/persistence.md#t1037004) |
| `T1037.005` | Startup Items | [Persistence](/techniques/persistence.md#t1037005) |
| `T1039` | Data from Network Shared Drive | [Collection](/techniques/collection.md#t1039) |
| `T1040` | Network Sniffing | [Credential Access](/techniques/credential-access.md#t1040) |
| `T1041` | Exfiltration Over C2 Channel | [Exfiltration](/techniques/exfiltration.md#t1041) |
| `T1046` | Network Service Discovery | [Discovery](/techniques/discovery.md#t1046) |
| `T1047` | Windows Management Instrumentation | [Execution](/techniques/execution.md#t1047) |
| `T1048` | Exfiltration Over Alternative Protocol | [Exfiltration](/techniques/exfiltration.md#t1048) |
| `T1048.001` | Exfiltration Over Symmetric Encrypted Non-C2 Protocol | [Exfiltration](/techniques/exfiltration.md#t1048001) |
| `T1048.002` | Exfiltration Over Asymmetric Encrypted Non-C2 Protocol | [Exfiltration](/techniques/exfiltration.md#t1048002) |
| `T1048.003` | Exfiltration Over Unencrypted Non-C2 Protocol | [Exfiltration](/techniques/exfiltration.md#t1048003) |
| `T1049` | System Network Connections Discovery | [Discovery](/techniques/discovery.md#t1049) |
| `T1052` | Exfiltration Over Physical Medium | [Exfiltration](/techniques/exfiltration.md#t1052) |
| `T1052.001` | Exfiltration over USB | [Exfiltration](/techniques/exfiltration.md#t1052001) |
| `T1053` | Scheduled Task/Job | [Execution](/techniques/execution.md#t1053) |
| `T1053.002` | At | [Execution](/techniques/execution.md#t1053002) |
| `T1053.003` | Cron | [Execution](/techniques/execution.md#t1053003) |
...
| `T1056.003` | Web Portal Capture | [Collection](/techniques/collection.md#t1056003) |
| `T1056.004` | Credential API Hooking | [Collection](/techniques/collection.md#t1056004) |
| `T1057` | Process Discovery | [Discovery](/techniques/discovery.md#t1057) |
| `T1059` | Command and Scripting Interpreter | [Execution](/techniques/execution.md#t1059) |
| `T1059.001` | PowerShell | [Execution](/techniques/execution.md#t1059001) |
| `T1059.002` | AppleScript | [Execution](/techniques/execution.md#t1059002) |
| `T1059.003` | Windows Command Shell | [Execution](/techniques/execution.md#t1059003) |
| `T1059.004` | Unix Shell | [Execution](/techniques/execution.md#t1059004) |
| `T1059.005` | Visual Basic | [Execution](/techniques/execution.md#t1059005) |
| `T1059.006` | Python | [Execution](/techniques/execution.md#t1059006) |
| `T1059.007` | JavaScript | [Execution](/techniques/execution.md#t1059007) |
| `T1059.008` | Network Device CLI | [Execution](/techniques/execution.md#t1059008) |
| `T1059.009` | Cloud API | [Execution](/techniques/execution.md#t1059009) |
| `T1059.010` | AutoHotKey & AutoIT | [Execution](/techniques/execution.md#t1059010) |
| `T1059.011` | Lua | [Execution](/techniques/execution.md#t1059011) |
| `T1059.012` | Hypervisor CLI | [Execution](/techniques/execution.md#t1059012) |
| `T1059.013` | Container CLI/API | [Execution](/techniques/execution.md#t1059013) |
| `T1068` | Exploitation for Privilege Escalation | [Privilege Escalation](/techniques/privilege-escalation.md#t1068) |
| `T1069` | Permission Groups Discovery | [Discovery](/techniques/discovery.md#t1069) |
...
| `T1071.003` | Mail Protocols | [Command and Control](/techniques/command-and-control.md#t1071003) |
| `T1071.004` | DNS | [Command and Control](/techniques/command-and-control.md#t1071004) |
| `T1071.005` | Publish/Subscribe Protocols | [Command and Control](/techniques/command-and-control.md#t1071005) |
| `T1072` | Software Deployment Tools | [Execution](/techniques/execution.md#t1072) |
...
| `T1087` | Account Discovery | [Discovery](/techniques/discovery.md#t1087) |
| `T1087.001` | Local Account | [Discovery](/techniques/discovery.md#t1087001) |
| `T1087.002` | Domain Account | [Discovery](/techniques/discovery.md#t1087002) |
| `T1087.003` | Email Account | [Discovery](/techniques/discovery.md#t1087003) |
| `T1087.004` | Cloud Account | [Discovery](/techniques/discovery.md#t1087004) |
| `T1090` | Proxy | [Command and Control](/techniques/command-and-control.md#t1090) |
| `T1090.001` | Internal Proxy | [Command and Control](/techniques/command-and-control.md#t1090001) |
| `T1090.002` | External Proxy | [Command and Control](/techniques/command-and-control.md#t1090002) |
| `T1090.003` | Multi-hop Proxy | [Command and Control](/techniques/command-and-control.md#t1090003) |
| `T1090.004` | Domain Fronting | [Command and Control](/techniques/command-and-control.md#t1090004) |
| `T1091` | Replication Through Removable Media | [Lateral Movement](/techniques/lateral-movement.md#t1091) |
| `T1092` | Communication Through Removable Media | [Command and Control](/techniques/command-and-control.md#t1092) |
| `T1095` | Non-Application Layer Protocol | [Command and Control](/techniques/command-and-control.md#t1095) |
| `T1098` | Account Manipulation | [Persistence](/techniques/persistence.md#t1098) |
| `T1098.001` | Additional Cloud Credentials | [Persistence](/techniques/persistence.md#t1098001) |
| `T1098.002` | Additional Email Delegate Permissions | [Persistence](/techniques/persistence.md#t1098002) |
| `T1098.003` | Additional Cloud Roles | [Persistence](/techniques/persistence.md#t1098003) |
| `T1098.004` | SSH Authorized Keys | [Persistence](/techniques/persistence.md#t1098004) |
| `T1098.005` | Device Registration | [Persistence](/techniques/persistence.md#t1098005) |
| `T1098.006` | Additional Container Cluster Roles | [Persistence](/techniques/persistence.md#t1098006) |
| `T1098.007` | Additional Local or Domain Groups | [Persistence](/techniques/persistence.md#t1098007) |
| `T1102` | Web Service | [Command and Control](/techniques/command-and-control.md#t1102) |
| `T1102.001` | Dead Drop Resolver | [Command and Control](/techniques/command-and-control.md#t1102001) |
| `T1102.002` | Bidirectional Communication | [Command and Control](/techniques/command-and-control.md#t1102002) |
| `T1102.003` | One-Way Communication | [Command and Control](/techniques/command-and-control.md#t1102003) |
| `T1104` | Multi-Stage Channels | [Command and Control](/techniques/command-and-control.md#t1104) |
| `T1105` | Ingress Tool Transfer | [Command and Control](/techniques/command-and-control.md#t1105) |
| `T1106` | Native API | [Execution](/techniques/execution.md#t1106) |
| `T1110` | Brute Force | [Credential Access](/techniques/credential-access.md#t1110) |
| `T1110.001` | Password Guessing | [Credential Access](/techniques/credential-access.md#t1110001) |
| `T1110.002` | Password Cracking | [Credential Access](/techniques/credential-access.md#t1110002) |
...
| `T1114.002` | Remote Email Collection | [Collection](/techniques/collection.md#t1114002) |
| `T1114.003` | Email Forwarding Rule | [Collection](/techniques/collection.md#t1114003) |
| `T1115` | Clipboard Data | [Collection](/techniques/collection.md#t1115) |
| `T1119` | Automated Collection | [Collection](/techniques/collection.md#t1119) |
| `T1120` | Peripheral Device Discovery | [Discovery](/techniques/discovery.md#t1120) |
...
| `T1136.002` | Domain Account | [Persistence](/techniques/persistence.md#t1136002) |
| `T1136.003` | Cloud Account | [Persistence](/techniques/persistence.md#t1136003) |
| `T1137` | Office Application Startup | [Persistence](/techniques/persistence.md#t1137) |
| `T1137.001` | Office Template Macros | [Persistence](/techniques/persistence.md#t1137001) |
| `T1137.002` | Office Test | [Persistence](/techniques/persistence.md#t1137002) |
| `T1137.003` | Outlook Forms | [Persistence](/techniques/persistence.md#t1137003) |
...
| `T1185` | Browser Session Hijacking | [Collection](/techniques/collection.md#t1185) |
| `T1187` | Forced Authentication | [Credential Access](/techniques/credential-access.md#t1187) |
| `T1189` | Drive-by Compromise | [Initial Access](/techniques/initial-access.md#t1189) |
| `T1190` | Exploit Public-Facing Application | [Initial Access](/techniques/initial-access.md#t1190) |
| `T1195` | Supply Chain Compromise | [Initial Access](/techniques/initial-access.md#t1195) |
...
| `T1204.002` | Malicious File | [Execution](/techniques/execution.md#t1204002) |
...
| `T1213.002` | Sharepoint | [Collection](/techniques/collection.md#t1213002) |
| `T1213.003` | Code Repositories | [Collection](/techniques/collection.md#t1213003) |
...
| `T1489` | Service Stop | [Impact](/techniques/impact.md#t1489) |
| `T1490` | Inhibit System Recovery | [Impact](/techniques/impact.md#t1490) |
| `T1491` | Defacement | [Impact](/techniques/impact.md#t1491) |
| `T1491.001` | Internal Defacement | [Impact](/techniques/impact.md#t1491001) |
| `T1491.002` | External Defacement | [Impact](/techniques/impact.md#t1491002) |
| `T1495` | Firmware Corruption | [Impact](/techniques/impact.md#t1495) |
| `T1496` | Resource Hijacking | [Impact](/techniques/impact.md#t1496) |
| `T1496.001` | Compute Hijacking | [Impact](/techniques/impact.md#t1496001) |
...
| `T1499` | Endpoint Denial of Service | [Impact](/techniques/impact.md#t1499) |
| `T1499.001` | OS Exhaustion Flood | [Impact](/techniques/impact.md#t1499001) |
| `T1499.002` | Service Exhaustion Flood | [Impact](/techniques/impact.md#t1499002) |
| `T1499.003` | Application Exhaustion Flood | [Impact](/techniques/impact.md#t1499003) |
| `T1499.004` | Application or System Exploitation | [Impact](/techniques/impact.md#t1499004) |
| `T1505` | Server Software Component | [Persistence](/techniques/persistence.md#t1505) |
| `T1505.001` | SQL Stored Procedures | [Persistence](/techniques/persistence.md#t1505001) |
| `T1505.002` | Transport Agent | [Persistence](/techniques/persistence.md#t1505002) |
| `T1505.003` | Web Shell | [Persistence](/techniques/persistence.md#t1505003) |
| `T1505.004` | IIS Components | [Persistence](/techniques/persistence.md#t1505004) |
| `T1505.005` | Terminal Services DLL | [Persistence](/techniques/persistence.md#t1505005) |
| `T1505.006` | vSphere Installation Bundles | [Persistence](/techniques/persistence.md#t1505006) |
| `T1518` | Software Discovery | [Discovery](/techniques/discovery.md#t1518) |
| `T1518.001` | Security Software Discovery | [Discovery](/techniques/discovery.md#t1518001) |
| `T1518.002` | Backup Software Discovery | [Discovery](/techniques/discovery.md#t1518002) |
| `T1525` | Implant Internal Image | [Persistence](/techniques/persistence.md#t1525) |
| `T1526` | Cloud Service Discovery | [Discovery](/techniques/discovery.md#t1526) |
| `T1528` | Steal Application Access Token | [Credential Access](/techniques/credential-access.md#t1528) |
| `T1529` | System Shutdown/Reboot | [Impact](/techniques/impact.md#t1529) |
...
| `T1543.003` | Windows Service | [Persistence](/techniques/persistence.md#t1543003) |
| `T1543.004` | Launch Daemon | [Persistence](/techniques/persistence.md#t1543004) |
| `T1543.005` | Container Service | [Persistence](/techniques/persistence.md#t1543005) |
| `T1546` | Event Triggered Execution | [Privilege Escalation](/techniques/privilege-escalation.md#t1546) |
| `T1546.001` | Change Default File Association | [Privilege Escalation](/techniques/privilege-escalation.md#t1546001) |
| `T1546.002` | Screensaver | [Privilege Escalation](/techniques/privilege-escalation.md#t1546002) |
| `T1546.003` | Windows Management Instrumentation Event Subscription | [Privilege Escalation](/techniques/privilege-escalation.md#t1546003) |
| `T1546.004` | Unix Shell Configuration Modification | [Privilege Escalation](/techniques/privilege-escalation.md#t1546004) |
| `T1546.005` | Trap | [Privilege Escalation](/techniques/privilege-escalation.md#t1546005) |
| `T1546.006` | LC_LOAD_DYLIB Addition | [Privilege Escalation](/techniques/privilege-escalation.md#t1546006) |
| `T1546.007` | Netsh Helper DLL | [Privilege Escalation](/techniques/privilege-escalation.md#t1546007) |
| `T1546.008` | Accessibility Features | [Privilege Escalation](/techniques/privilege-escalation.md#t1546008) |
| `T1546.009` | AppCert DLLs | [Privilege Escalation](/techniques/privilege-escalation.md#t1546009) |
| `T1546.010` | AppInit DLLs | [Privilege Escalation](/techniques/privilege-escalation.md#t1546010) |
| `T1546.011` | Application Shimming | [Privilege Escalation](/techniques/privilege-escalation.md#t1546011) |
| `T1546.012` | Image File Execution Options Injection | [Privilege Escalation](/techniques/privilege-escalation.md#t1546012) |
| `T1546.013` | PowerShell Profile | [Privilege Escalation](/techniques/privilege-escalation.md#t1546013) |
| `T1546.014` | Emond | [Privilege Escalation](/techniques/privilege-escalation.md#t1546014) |
| `T1546.015` | Component Object Model Hijacking | [Privilege Escalation](/techniques/privilege-escalation.md#t1546015) |
| `T1546.016` | Installer Packages | [Privilege Escalation](/techniques/privilege-escalation.md#t1546016) |
| `T1546.017` | Udev Rules | [Persistence](/techniques/persistence.md#t1546017) |
| `T1546.018` | Python Startup Hooks | [Persistence](/techniques/persistence.md#t1546018) |
| `T1547` | Boot or Logon Autostart Execution | [Persistence](/techniques/persistence.md#t1547) |
| `T1547.001` | Registry Run Keys / Startup Folder | [Persistence](/techniques/persistence.md#t1547001) |
| `T1547.002` | Authentication Package | [Persistence](/techniques/persistence.md#t1547002) |
| `T1547.003` | Time Providers | [Persistence](/techniques/persistence.md#t1547003) |
| `T1547.004` | Winlogon Helper DLL | [Persistence](/techniques/persistence.md#t1547004) |
| `T1547.005` | Security Support Provider | [Persistence](/techniques/persistence.md#t1547005) |
| `T1547.006` | Kernel Modules and Extensions | [Persistence](/techniques/persistence.md#t1547006) |
| `T1547.007` | Re-opened Applications | [Persistence](/techniques/persistence.md#t1547007) |
| `T1547.008` | LSASS Driver | [Persistence](/techniques/persistence.md#t1547008) |
| `T1547.009` | Shortcut Modification | [Persistence](/techniques/persistence.md#t1547009) |
| `T1547.010` | Port Monitors | [Persistence](/techniques/persistence.md#t1547010) |
| `T1547.012` | Print Processors | [Persistence](/techniques/persistence.md#t1547012) |
| `T1547.013` | XDG Autostart Entries | [Persistence](/techniques/persistence.md#t1547013) |
| `T1547.014` | Active Setup | [Persistence](/techniques/persistence.md#t1547014) |
| `T1547.015` | Login Items | [Persistence](/techniques/persistence.md#t1547015) |
| `T1548` | Abuse Elevation Control Mechanism | [Privilege Escalation](/techniques/privilege-escalation.md#t1548) |
| `T1548.001` | Setuid and Setgid | [Privilege Escalation](/techniques/privilege-escalation.md#t1548001) |
| `T1548.002` | Bypass User Account Control | [Privilege Escalation](/techniques/privilege-escalation.md#t1548002) |
...
| `T1552.003` | Shell History | [Credential Access](/techniques/credential-access.md#t1552003) |
| `T1552.004` | Private Keys | [Credential Access](/techniques/credential-access.md#t1552004) |
| `T1552.005` | Cloud Instance Metadata API | [Credential Access](/techniques/credential-access.md#t1552005) |
...
| `T1555.002` | Securityd Memory | [Credential Access](/techniques/credential-access.md#t1555002) |
| `T1555.003` | Credentials from Web Browsers | [Credential Access](/techniques/credential-access.md#t1555003) |
...
| `T1558` | Steal or Forge Kerberos Tickets | [Credential Access](/techniques/credential-access.md#t1558) |
| `T1558.001` | Golden Ticket | [Credential Access](/techniques/credential-access.md#t1558001) |
| `T1558.002` | Silver Ticket | [Credential Access](/techniques/credential-access.md#t1558002) |
| `T1558.003` | Kerberoasting | [Credential Access](/techniques/credential-access.md#t1558003) |
| `T1558.004` | AS-REP Roasting | [Credential Access](/techniques/credential-access.md#t1558004) |
| `T1558.005` | Ccache Files | [Credential Access](/techniques/credential-access.md#t1558005) |
| `T1559` | Inter-Process Communication | [Execution](/techniques/execution.md#t1559) |
| `T1559.001` | Component Object Model | [Execution](/techniques/execution.md#t1559001) |
| `T1559.002` | Dynamic Data Exchange | [Execution](/techniques/execution.md#t1559002) |
| `T1559.003` | XPC Services | [Execution](/techniques/execution.md#t1559003) |
| `T1560` | Archive Collected Data | [Collection](/techniques/collection.md#t1560) |
| `T1560.001` | Archive via Utility | [Collection](/techniques/collection.md#t1560001) |
| `T1560.002` | Archive via Library | [Collection](/techniques/collection.md#t1560002) |
| `T1560.003` | Archive via Custom Method | [Collection](/techniques/collection.md#t1560003) |
...
| `T1565.003` | Runtime Data Manipulation | [Impact](/techniques/impact.md#t1565003) |
| `T1566` | Phishing | [Initial Access](/techniques/initial-access.md#t1566) |
| `T1566.001` | Spearphishing Attachment | [Initial Access](/techniques/initial-access.md#t1566001) |
| `T1566.002` | Spearphishing Link | [Initial Access](/techniques/initial-access.md#t1566002) |
| `T1566.003` | Spearphishing via Service | [Initial Access](/techniques/initial-access.md#t1566003) |
| `T1566.004` | Spearphishing Voice | [Initial Access](/techniques/initial-access.md#t1566004) |
| `T1567` | Exfiltration Over Web Service | [Exfiltration](/techniques/exfiltration.md#t1567) |
| `T1567.001` | Exfiltration to Code Repository | [Exfiltration](/techniques/exfiltration.md#t1567001) |
| `T1567.002` | Exfiltration to Cloud Storage | [Exfiltration](/techniques/exfiltration.md#t1567002) |
| `T1567.003` | Exfiltration to Text Storage Sites | [Exfiltration](/techniques/exfiltration.md#t1567003) |
| `T1567.004` | Exfiltration Over Webhook | [Exfiltration](/techniques/exfiltration.md#t1567004) |
| `T1568` | Dynamic Resolution | [Command and Control](/techniques/command-and-control.md#t1568) |
| `T1568.001` | Fast Flux DNS | [Command and Control](/techniques/command-and-control.md#t1568001) |
| `T1568.002` | Domain Generation Algorithms | [Command and Control](/techniques/command-and-control.md#t1568002) |
| `T1568.003` | DNS Calculation | [Command and Control](/techniques/command-and-control.md#t1568003) |
| `T1569` | System Services | [Execution](/techniques/execution.md#t1569) |
| `T1569.001` | Launchctl | [Execution](/techniques/execution.md#t1569001) |
| `T1569.002` | Service Execution | [Execution](/techniques/execution.md#t1569002) |
| `T1569.003` | Systemctl | [Execution](/techniques/execution.md#t1569003) |
| `T1570` | Lateral Tool Transfer | [Lateral Movement](/techniques/lateral-movement.md#t1570) |
| `T1571` | Non-Standard Port | [Command and Control](/techniques/command-and-control.md#t1571) |
| `T1572` | Protocol Tunneling | [Command and Control](/techniques/command-and-control.md#t1572) |
...
| `T1583.002` | DNS Server | [Resource Development](/techniques/resource-development.md#t1583002) |
| `T1583.003` | Virtual Private Server | [Resource Development](/techniques/resource-development.md#t1583003) |
| `T1583.004` | Server | [Resource Development](/techniques/resource-development.md#t1583004) |
| `T1583.005` | Botnet | [Resource Development](/techniques/resource-development.md#t1583005) |
| `T1583.006` | Web Services | [Resource Development](/techniques/resource-development.md#t1583006) |
| `T1583.007` | Serverless | [Resource Development](/techniques/resource-development.md#t1583007) |
| `T1583.008` | Malvertising | [Resource Development](/techniques/resource-development.md#t1583008) |
| `T1584` | Compromise Infrastructure | [Resource Development](/techniques/resource-development.md#t1584) |
| `T1584.001` | Domains | [Resource Development](/techniques/resource-development.md#t1584001) |
| `T1584.002` | DNS Server | [Resource Development](/techniques/resource-development.md#t1584002) |
| `T1584.003` | Virtual Private Server | [Resource Development](/techniques/resource-development.md#t1584003) |
| `T1584.004` | Server | [Resource Development](/techniques/resource-development.md#t1584004) |
| `T1584.005` | Botnet | [Resource Development](/techniques/resource-development.md#t1584005) |
| `T1584.006` | Web Services | [Resource Development](/techniques/resource-development.md#t1584006) |
| `T1584.007` | Serverless | [Resource Development](/techniques/resource-development.md#t1584007) |
| `T1584.008` | Network Devices | [Resource Development](/techniques/resource-development.md#t1584008) |
| `T1585` | Establish Accounts | [Resource Development](/techniques/resource-development.md#t1585) |
| `T1585.001` | Social Media Accounts | [Resource Development](/techniques/resource-development.md#t1585001) |
| `T1585.002` | Email Accounts | [Resource Development](/techniques/resource-development.md#t1585002) |
| `T1585.003` | Cloud Accounts | [Resource Development](/techniques/resource-development.md#t1585003) |
| `T1586` | Compromise Accounts | [Resource Development](/techniques/resource-development.md#t1586) |
| `T1586.001` | Social Media Accounts | [Resource Development](/techniques/resource-development.md#t1586001) |
| `T1586.002` | Email Accounts | [Resource Development](/techniques/resource-development.md#t1586002) |
| `T1586.003` | Cloud Accounts | [Resource Development](/techniques/resource-development.md#t1586003) |
| `T1587` | Develop Capabilities | [Resource Development](/techniques/resource-development.md#t1587) |
| `T1587.001` | Malware | [Resource Development](/techniques/resource-development.md#t1587001) |
| `T1587.002` | Code Signing Certificates | [Resource Development](/techniques/resource-development.md#t1587002) |
| `T1587.003` | Digital Certificates | [Resource Development](/techniques/resource-development.md#t1587003) |
| `T1587.004` | Exploits | [Resource Development](/techniques/resource-development.md#t1587004) |
| `T1588` | Obtain Capabilities | [Resource Development](/techniques/resource-development.md#t1588) |
| `T1588.001` | Malware | [Resource Development](/techniques/resource-development.md#t1588001) |
| `T1588.002` | Tool | [Resource Development](/techniques/resource-development.md#t1588002) |
| `T1588.003` | Code Signing Certificates | [Resource Development](/techniques/resource-development.md#t1588003) |
| `T1588.004` | Digital Certificates | [Resource Development](/techniques/resource-development.md#t1588004) |
| `T1588.005` | Exploits | [Resource Development](/techniques/resource-development.md#t1588005) |
| `T1588.006` | Vulnerabilities | [Resource Development](/techniques/resource-development.md#t1588006) |
| `T1588.007` | Artificial Intelligence | [Resource Development](/techniques/resource-development.md#t1588007) |
| `T1589` | Gather Victim Identity Information | [Reconnaissance](/techniques/reconnaissance.md#t1589) |
| `T1589.001` | Credentials | [Reconnaissance](/techniques/reconnaissance.md#t1589001) |
| `T1589.002` | Email Addresses | [Reconnaissance](/techniques/reconnaissance.md#t1589002) |
| `T1589.003` | Employee Names | [Reconnaissance](/techniques/reconnaissance.md#t1589003) |
| `T1590` | Gather Victim Network Information | [Reconnaissance](/techniques/reconnaissance.md#t1590) |
| `T1590.001` | Domain Properties | [Reconnaissance](/techniques/reconnaissance.md#t1590001) |
| `T1590.002` | DNS | [Reconnaissance](/techniques/reconnaissance.md#t1590002) |
| `T1590.003` | Network Trust Dependencies | [Reconnaissance](/techniques/reconnaissance.md#t1590003) |
| `T1590.004` | Network Topology | [Reconnaissance](/techniques/reconnaissance.md#t1590004) |
| `T1590.005` | IP Addresses | [Reconnaissance](/techniques/reconnaissance.md#t1590005) |
| `T1590.006` | Network Security Appliances | [Reconnaissance](/techniques/reconnaissance.md#t1590006) |
| `T1591` | Gather Victim Org Information | [Reconnaissance](/techniques/reconnaissance.md#t1591) |
| `T1591.001` | Determine Physical Locations | [Reconnaissance](/techniques/reconnaissance.md#t1591001) |
| `T1591.002` | Business Relationships | [Reconnaissance](/techniques/reconnaissance.md#t1591002) |
| `T1591.003` | Identify Business Tempo | [Reconnaissance](/techniques/reconnaissance.md#t1591003) |
| `T1591.004` | Identify Roles | [Reconnaissance](/techniques/reconnaissance.md#t1591004) |
| `T1592` | Gather Victim Host Information | [Reconnaissance](/techniques/reconnaissance.md#t1592) |
| `T1592.001` | Hardware | [Reconnaissance](/techniques/reconnaissance.md#t1592001) |
| `T1592.002` | Software | [Reconnaissance](/techniques/reconnaissance.md#t1592002) |
| `T1592.003` | Firmware | [Reconnaissance](/techniques/reconnaissance.md#t1592003) |
| `T1592.004` | Client Configurations | [Reconnaissance](/techniques/reconnaissance.md#t1592004) |
| `T1593` | Search Open Websites/Domains | [Reconnaissance](/techniques/reconnaissance.md#t1593) |
| `T1593.001` | Social Media | [Reconnaissance](/techniques/reconnaissance.md#t1593001) |
| `T1593.002` | Search Engines | [Reconnaissance](/techniques/reconnaissance.md#t1593002) |
| `T1593.003` | Code Repositories | [Reconnaissance](/techniques/reconnaissance.md#t1593003) |
| `T1594` | Search Victim-Owned Websites | [Reconnaissance](/techniques/reconnaissance.md#t1594) |
| `T1595` | Active Scanning | [Reconnaissance](/techniques/reconnaissance.md#t1595) |
| `T1595.001` | Scanning IP Blocks | [Reconnaissance](/techniques/reconnaissance.md#t1595001) |
| `T1595.002` | Vulnerability Scanning | [Reconnaissance](/techniques/reconnaissance.md#t1595002) |
| `T1595.003` | Wordlist Scanning | [Reconnaissance](/techniques/reconnaissance.md#t1595003) |
| `T1596` | Search Open Technical Databases | [Reconnaissance](/techniques/reconnaissance.md#t1596) |
| `T1596.001` | DNS/Passive DNS | [Reconnaissance](/techniques/reconnaissance.md#t1596001) |
| `T1596.002` | WHOIS | [Reconnaissance](/techniques/reconnaissance.md#t1596002) |
| `T1596.003` | Digital Certificates | [Reconnaissance](/techniques/reconnaissance.md#t1596003) |
| `T1596.004` | CDNs | [Reconnaissance](/techniques/reconnaissance.md#t1596004) |
| `T1596.005` | Scan Databases | [Reconnaissance](/techniques/reconnaissance.md#t1596005) |
| `T1597` | Search Closed Sources | [Reconnaissance](/techniques/reconnaissance.md#t1597) |
| `T1597.001` | Threat Intel Vendors | [Reconnaissance](/techniques/reconnaissance.md#t1597001) |
| `T1597.002` | Purchase Technical Data | [Reconnaissance](/techniques/reconnaissance.md#t1597002) |
| `T1598` | Phishing for Information | [Reconnaissance](/techniques/reconnaissance.md#t1598) |
| `T1598.001` | Spearphishing Service | [Reconnaissance](/techniques/reconnaissance.md#t1598001) |
...
| `T1606` | Forge Web Credentials | [Credential Access](/techniques/credential-access.md#t1606) |
| `T1606.001` | Web Cookies | [Credential Access](/techniques/credential-access.md#t1606001) |
| `T1606.002` | SAML Tokens | [Credential Access](/techniques/credential-access.md#t1606002) |
| `T1608` | Stage Capabilities | [Resource Development](/techniques/resource-development.md#t1608) |
| `T1608.001` | Upload Malware | [Resource Development](/techniques/resource-development.md#t1608001) |
| `T1608.002` | Upload Tool | [Resource Development](/techniques/resource-development.md#t1608002) |
| `T1608.003` | Install Digital Certificate | [Resource Development](/techniques/resource-development.md#t1608003) |
| `T1608.004` | Drive-by Target | [Resource Development](/techniques/resource-development.md#t1608004) |
...
| `T1651` | Cloud Administration Command | [Execution](/techniques/execution.md#t1651) |
